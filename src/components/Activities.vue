...
const activities = [
  "Reviewer in [Dalhousie Computer Science In-House (DCSI)](https://dcsi.cs.dal.ca/) Conference in 2021 and 2022.",
  "<span class='text-info'>Vice President External Advocacy</span> in _Dalhousie Association of Graduate students (DAGS)_.",
  "<span class='text-info'>Graduate Student Representative</span> in _Dalhousie Student Union (DSU) Council_.",
  "<span class='text-info'>Graduate Student Representative</span> in _Faculty of Graduate Studies (FGS) Council_, Dalhousie University.",
